    ...
    public CreditAccount(int initialBalance, int creditLimit, int rate) {
        if (rate < 0) {
            throw new IllegalArgumentException(
                    "Ставка кредитования для расчета долга за отрицательный баланс не может быть отрицательной или равной нулю, а у вас: " + rate
            );
        }
        if (initialBalance < 0) {
            throw new IllegalArgumentException(
        ...
        if (creditLimit < 0) {
            throw new IllegalArgumentException(
                    "Максимальная сумма задолжности банку не может быть отрицательной или равной нулю, а у вас:" + creditLimit
            );
        }
